...
cの回転対称比較して最小値を決定するcheckRotationsの部分でsymmetryする まだ未完成

$ nvcc -O3 -arch=sm_61 -m64 -prec-div=false 10CUDA_constellation_warp.cu && ./a.out -g
...
18:        666090624               0     000:00:00:19.06
*/
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
