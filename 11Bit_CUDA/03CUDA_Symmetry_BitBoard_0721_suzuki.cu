...
__global__
void BitBoard_cuda_kernel_b1(register int size,register int mark,unsigned int* totalDown,unsigned int* totalLeft,unsigned int* totalRight,unsigned int* d_results,unsigned int* d_uniq,register int totalCond,register int h_row,int B1)
{
...
__global__
void BitBoard_cuda_kernel_b2(register int size,register int mark,unsigned int* totalDown,unsigned int* totalLeft,unsigned int* totalRight,unsigned int* d_results,unsigned int* d_uniq,register int totalCond,unsigned int* t_aBoard,register int h_row,register int B1,register int B2,register int SM,register int LM,register int TB,register int EB)
{
  register const unsigned int mask=(1<<size)-1;
  register unsigned int total=0;
  register unsigned int unique=0;
...
void symmetry_build_bitBoard(register unsigned int size,register int steps)
{
