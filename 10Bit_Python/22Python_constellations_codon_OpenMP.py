...
bash-5.1$ which mpicc
bash-5.1$ /usr/local/bin/mpicc
bash-5.1$ sudo ln -s /usr/local/bin/mpicc /usr/bin/mpicc

bash-5.1$ which mpic++
bash-5.1$ /usr/local/bin/mpic++
bash-5.1$ sudo ln -s /usr/local/bin/mpic++ /usr/bin/mpic++
"""
