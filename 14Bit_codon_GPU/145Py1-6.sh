...
# - Because task order and DFS arithmetic are identical, cases 1-5 are locked directly to the
#   validated 144 partial totals; case 6 checks the full N=21 total.
...
LOGDIR="145Py_logs_N21_validation_${TS}"
