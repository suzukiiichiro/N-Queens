...
# =============================================================================
# 341_bucket_run_sweep2_driver.sh
#
...
#   SWEEP="64 96 256 64" bash 341_bucket_run_sweep2_driver.sh   # quick version
#   DRY_RUN=1        bash 341_bucket_run_sweep2_driver.sh       # plan only
#   AGGREGATE_ONLY=1 SWEEPDIR=./341_bucket_run_sweep2_<ts> \
#                    bash 341_bucket_run_sweep2_driver.sh       # rebuild table
# =============================================================================

HARNESS=${HARNESS:-./341Py_bucket_run_sweep2_validate_N21_full_once.sh}
SRC=${SRC:-./341Py_bucket_run_sweep2.py}
LOGPREFIX=${LOGPREFIX:-./341Py_bucket_run_sweep2_logs_N21_full_once_}
SWEEP=${SWEEP:-"64 80 96 128 256 64"}
DRY_RUN=${DRY_RUN:-0}
...
REF_RUN64=${REF_RUN64:-446.390}

TS=$(date -u +%Y%m%d_%H%M%S)
SWEEPDIR=${SWEEPDIR:-./341_bucket_run_sweep2_${TS}}
mkdir -p "$SWEEPDIR"
...
echo "[start] 341 bucket-run sweep2 driver"
