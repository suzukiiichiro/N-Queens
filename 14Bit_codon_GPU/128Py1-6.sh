...
# - The selected-chunk partial totals are intentionally not hard-coded, because chunkshape128
#   changes which records belong to each chunk. Full correctness is checked in case 6.
...
# chunkshape128 changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
