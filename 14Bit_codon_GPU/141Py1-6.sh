...
# 141 validation harness
# - Candidate: 141Py_scorestripe_chunkshape_probe
# - Kernel path remains generic-only. 141 is scorestripe_v9_lanephase32_octetfirstpairlock29 after the validated 140 v8 line.
# - This first-run harness checks partial_total emission and full correctness while using isolated 141 cache/log labels.
...
LOGDIR="141Py_logs_N21_validation_${TS}"
...
# chunkshape141 scorestripe_v9_lanephase32_octetfirstpairlock29 changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
...
# ================================================================
# 2) 141 selected-chunk stress: former heavy band
# ================================================================
run_case \
...
# ================================================================
# 3) 141 selected-chunk stress: former d2base14-density band
# ================================================================
run_case \
