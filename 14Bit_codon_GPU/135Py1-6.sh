...
# - This first-run harness checks partial_total emission and full correctness while using isolated 135 cache/log labels.
...
LOGDIR="135Py_logs_N21_validation_${TS}"
...
# chunkshape135 scorestripe_v4_lanephase32 changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
...
# ================================================================
# 2) 135 selected-chunk stress: former heavy band
# ================================================================
run_case \
...
# ================================================================
# 3) 135 selected-chunk stress: former d2base14-density band
# ================================================================
run_case \
