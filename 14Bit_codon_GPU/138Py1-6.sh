...
# 138 validation harness
# - Candidate: 138Py_scorestripe_chunkshape_probe
# - Kernel path remains generic-only. 138 is scorestripe_v6_lanephase32_oddphasebias from the validated 137 v5 line.
# - This first-run harness checks partial_total emission and full correctness while using isolated 138 cache/log labels.
...
LOGDIR="138Py_logs_N21_validation_${TS}"
...
# chunkshape138 scorestripe_v6_lanephase32_oddphasebias changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
...
# ================================================================
# 2) 138 selected-chunk stress: former heavy band
# ================================================================
run_case \
...
# ================================================================
# 3) 138 selected-chunk stress: former d2base14-density band
# ================================================================
run_case \
