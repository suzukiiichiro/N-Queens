...
VERSION_TAG:str="75 CHUNK ONLY DEBUG"
...
"""75 の auto sort 方針。N=20 だけ sort_mode=9、それ以外は安全側で sort_mode=0。"""
def auto_sort_mode(N:int)->int:
  if N==20:
    return 9
  return 0
  ...
  if argc == 1:
    ...
    if argc >= 9:
      ...
      if requested_preset!=5:
        print(f"[warning] preset_queens={requested_preset} is disabled in 75 CHUNK ONLY DEBUG; using 5")
      preset_queens_arg=5
    if argc >= 10:
