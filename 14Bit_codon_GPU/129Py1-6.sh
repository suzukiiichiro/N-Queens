...
# 129 validation harness
# - Candidate: 129Py_scorestripe_chunkshape_probe
# - Kernel path remains generic-only; 129 adds host-side score-aware chunkshape129_scorestripe_v1.
# - The selected-chunk partial totals are intentionally not hard-coded for the first run,
#   because score-aware shaping changes which records belong to each chunk.
...
LOGDIR="logs_N21_129_validation_${TS}"
...
# chunkshape129 changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
...
# ================================================================
# 2) 129 selected-chunk stress: former heavy band
# ================================================================
run_case \
...
# ================================================================
# 3) 129 selected-chunk stress: former d2base14-density band
# ================================================================
run_case \
