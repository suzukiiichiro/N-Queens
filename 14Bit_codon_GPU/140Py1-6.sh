...
# 140 validation harness
# - Candidate: 140Py_scorestripe_chunkshape_probe
# - Kernel path remains generic-only. 140 is scorestripe_v8_lanephase32_quartetpairmix after the validated 139 v7 line.
# - This first-run harness checks partial_total emission and full correctness while using isolated 140 cache/log labels.
...
LOGDIR="140Py_logs_N21_validation_${TS}"
...
# chunkshape140 scorestripe_v8_lanephase32_quartetpairmix changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
...
# ================================================================
# 2) 140 selected-chunk stress: former heavy band
# ================================================================
run_case \
...
# ================================================================
# 3) 140 selected-chunk stress: former d2base14-density band
# ================================================================
run_case \
