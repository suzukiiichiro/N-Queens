...
# 139 validation harness
# - Candidate: 139Py_scorestripe_chunkshape_probe
# - Kernel path remains generic-only. 139 is scorestripe_v7_lanephase32_pairphase11 from the validated 138 v6 line.
# - This first-run harness checks partial_total emission and full correctness while using isolated 139 cache/log labels.
...
LOGDIR="139Py_logs_N21_validation_${TS}"
...
# chunkshape139 scorestripe_v7_lanephase32_pairphase11 changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
...
# ================================================================
# 2) 139 selected-chunk stress: former heavy band
# ================================================================
run_case \
...
# ================================================================
# 3) 139 selected-chunk stress: former d2base14-density band
# ================================================================
run_case \
