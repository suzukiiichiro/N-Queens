...
Python/codon Ｎクイーン コンステレーション版 CUDA 高速ソルバ 45 trunk候補 32x484 + chunk内sort診断（ctrlrow mixed32 tuned）
...
def exec_solutions(N:int,constellations:List[Dict[str,int]],use_gpu:bool,gpu_block:int=32,gpu_max_blocks:int=484,gpu_log_level:int=0,gpu_sort_mode:int=0)->None:
  """
  機能:
