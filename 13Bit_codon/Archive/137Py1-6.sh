...
# 137 validation harness
# - Candidate: 137Py_scorestripe_chunkshape_probe
# - Kernel path remains generic-only. 137 is scorestripe_v5_lanephase32_phasejump from the validated 136 v4 line.
# - This first-run harness checks partial_total emission and full correctness while using isolated 137 cache/log labels.
...
LOGDIR="137Py_logs_N21_validation_${TS}"
...
# chunkshape137 scorestripe_v5_lanephase32_phasejump changes chunk composition, so only partial_total emission is checked.
# ================================================================
run_case \
...
# ================================================================
# 2) 137 selected-chunk stress: former heavy band
# ================================================================
run_case \
...
# ================================================================
# 3) 137 selected-chunk stress: former d2base14-density band
# ================================================================
run_case \
