...
def exec_solutions(N:int,constellations:List[Dict[str,int]],use_gpu:bool,gpu_split_row:int=-1,gpu_bucket_mode:int=1)->None:
  """
  機能:
...
def main()->None:
  ...
  if argc == 1:
    ...
    if arg == "-c":
      ...
      print("Usage: nqueens [-c | -g] [N | N_start N_end] [split_row] [bucket_mode]")
      return
  ...
  for N in range(nmin,nmax):
    ...
    if use_solution_cache:
        ...
        exec_solutions(N,constellations,use_gpu,gpu_split_row,gpu_bucket_mode)
