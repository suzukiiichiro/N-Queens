...
def main()->None:
  ...
  gpu_log_level:int=0
  gpu_sort_mode:int=-1
  bench_mode:int=0  # 0:normal, 1:N=20 warmup repeat, 2:N19 preheat, 3:N18+N19 preheat, 4:N20 repeat3 sweep
  # 70 REPEAT SWEEP: preset_queens は 5 固定。preset=6 は 48 で正解には直せたが速度面で不採用。
  ...
  if argc == 1:
    ...
    if argc >= 10:
      ...
      if bench_mode<0 or bench_mode>4:
