...
# 130 locked validation harness
# - Candidate: 130Py_scorestripe_chunkshape_probe
# - Kernel path remains generic-only; 130 adds host-side chunkshape130_scorestripe_v2.
...
LOGDIR="logs_N21_130_locked_validation_${TS}"
...
# ================================================================
# 2) 130 selected-chunk stress: heavy band
...
# ================================================================
# 3) 130 selected-chunk stress: d2base14-density band
