...
$ ./56Py_constellations_GPU_cuda_codon_original_ctrlrow_mixed32_32x484_stable_final -c
...
suzuki@cudacodon$ ./56Py_constellations_GPU_cuda_codon_original_ctrlrow_mixed32_32x484_stable_final -g 5 20 32 484 0 -1
GPU mode selected
...
56 STABLE FINAL を正式ベースライン化
N=20 と N≠20 の auto sort 分岐を固定
32x484 を標準構成として README / 実行ログに明記
不採用パターンを再探索対象から外す
次の高速化は sort_mode や max_blocks ではなく、
