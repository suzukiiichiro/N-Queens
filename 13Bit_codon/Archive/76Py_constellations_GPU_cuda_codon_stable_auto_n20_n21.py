...
CPU
$ ./76Py_constellations_GPU_cuda_codon_stable_auto_n20_n21 -c
...
suzuki@cudacodon$ ./76Py_constellations_GPU_cuda_codon_stable_auto_n20_n21 -g 5 20 32 484 0 -1 5 0
GPU mode selected
version        : 76 STABLE AUTO N20 N21
cross_stripe_safe: 0
...
17:          95815104                0          0:00:00.458    ok
18:         666090624                0          0:00:02.733    ok
...
VERSION_TAG:str="76 STABLE AUTO N20 N21"
...
def main()->None:
  ...
  bench_mode:int=0  # 0:normal, 1:N=20 warmup repeat, 2:N19 preheat, 3:N18+N19 preheat, 4:N20 repeat3 sweep, 5:N20 repeat2 benchmark, 6:reorder-only debug, 7:chunk-only debug
  ...
  if argc == 1:
    ...
    if argc >= 9:
      ...
      if requested_preset!=5:
        print(f"[warning] preset_queens={requested_preset} is disabled in 76 STABLE AUTO N20 N21; using 5")
      preset_queens_arg=5
    if argc >= 10:
      bench_mode=int(sys.argv[9])
      if bench_mode<0 or bench_mode>7:
