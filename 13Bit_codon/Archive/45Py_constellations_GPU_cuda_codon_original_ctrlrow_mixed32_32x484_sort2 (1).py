...
Python/codon Ｎクイーン コンステレーション版 CUDA 高速ソルバ 45 trunk候補 32x484 sort_mode=2 + chunk内sort診断（ctrlrow mixed32 tuned）
...
sort_mode  = 0 : sortなし
             ...
             2 : chunk内 funcptn sort、現trunk基準

$ codon build -release <filename>.py
$ ./<filename> -g 18 18 32 484 0 2
または
$ ./<filename> -g 18 19  N18とN19の両方を処理 32 484 0 2 
======
...
def exec_solutions(N:int,constellations:List[Dict[str,int]],use_gpu:bool,gpu_block:int=32,gpu_max_blocks:int=484,gpu_log_level:int=0,gpu_sort_mode:int=2)->None:
  """
  機能:
