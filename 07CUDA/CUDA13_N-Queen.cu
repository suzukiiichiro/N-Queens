...
$ gcc -Wall -W -O3 -g -ftrapv -std=c99 -pthread GCC13.c && ./a.out -r
...
$ gcc -Wall -W -O3 -g -ftrapv -std=c99 -pthread GCC13.c && ./a.out -c
...
$ nvcc -O3 CUDA12_N-Queen.cu  && ./a.out -g
