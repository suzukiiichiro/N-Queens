/**
 ...
 実行
 $ gcc -Wall -W -O3 -g -ftrapv -std=c99 GCC09.c && ./a.out [-c|-r]
...
bash-3.2$ gcc -Wall -W -O3 -g -ftrapv -std=c99 -pthread GCC09.c && ./a.out -r
...
bash-3.2$ gcc -Wall -W -O3 -g -ftrapv -std=c99 -pthread GCC09.c && ./a.out -c
