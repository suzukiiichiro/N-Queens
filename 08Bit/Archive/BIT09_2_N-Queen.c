...
９−２．CPUR 再帰 ビットマップ＋対象解除＋q２７枝刈＋BackTrack1
...
int main(int argc,char** argv) {
  ...
  /** 出力と実行 */
  if(cpu){
    printf("\n\n９−２．CPU 非再帰 ビットマップ＋対象解除＋q２７枝刈＋BackTrack1\n");
  }else if(cpur){
    printf("\n\n９−２．CPUR 再帰 ビットマップ＋対象解除＋q２７枝刈＋BackTrack1\n");
  }else if(gpu){
    printf("\n\n９−２．GPU 非再帰 ビットマップ＋対象解除＋q２７枝刈＋BackTrack1\n");
  }else if(sgpu){
    printf("\n\n９−２．SGPU 非再帰 ビットマップ＋対象解除＋q２７枝刈＋BackTrack1\n");
  }
  if(cpu||cpur){
    printf("%s\n"," N:        Total       Unique        hh:mm:ss.ms");
    clock_t st;          //速度計測用
