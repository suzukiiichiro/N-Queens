...
>>>>>>> 931603d6560ef3978618c5780ffeb2bc8560aa83
    ...
    for(int j=0;j<si;j++){
      ...
      for(int k=0;k<si;k++){
        ...
        for(int kj4=0;kj4<si;kj4++){
          pt1[j][k][kj4]=(pthread_t*)malloc(sizeof(pthread_t)*si);
          if( pt1[j][k][kj4] == NULL ) { printf( "memory cannot alloc!\n" ); }
        }
      }
    }
  }
      ...
      for(int k=0;k<si;k++){
        ...
        for(int kj4=0;kj4<si;kj4++){
          ...
          for(int kj5=0;kj5<si;kj5++){
            pt3[j][k][kj4][kj5]=(pthread_t*)malloc(sizeof(pthread_t)*si);
            if( pt3[j][k][kj4][kj5] == NULL ) { printf( "memory cannot alloc!\n" ); }
          }
        }
      }
    }
    ...
    for(int j=0;j<si;j++){
      ...
      for(int k=0;k<si;k++){
        ...
        if( l[j][k] == NULL ) { printf( "memory cannot alloc!\n" ); }
          for(int kj4=0;kj4<si;kj4++){
            l[j][k][kj4]=(local*)malloc(sizeof(local)*si);
            if( l[j][k][kj4] == NULL ) { printf( "memory cannot alloc!\n" ); }
          }
      }
    }
  } 
