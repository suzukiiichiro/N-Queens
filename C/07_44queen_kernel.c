...
*/
//
CL_KERNEL_KEYWORD void backtrack1(CL_GLOBAL_KEYWORD struct queenState *state){
...
CL_KERNEL_KEYWORD void backtrack2(CL_GLOBAL_KEYWORD struct queenState *state){
  int index=get_global_id(0);
  struct queenState s ;
  s.si=state[index].si;
