...
void backTrack1(int y,int left,int down,int right,int SIZEE,
                                        int BOUND1,int MASK,int aBoard[],int *COUNT8){
...
void *run(void *args){
  ...
  if(BOUND1>0 && BOUND2<SIZEE && BOUND1<BOUND2){ 
    ...
    backTrack2(1,bit<<1,bit,bit>>1,SIZEE,BOUND1,BOUND2,MASK,SIDEMASK,LASTMASK,TOPBIT,ENDBIT,aBoard,&COUNT2,&COUNT4,&COUNT8); 
    ENDBIT>>=1; }
  l->COUNT2=COUNT2;
  l->COUNT4=COUNT4;
  l->COUNT8=COUNT8;
