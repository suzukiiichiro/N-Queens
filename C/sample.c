...
int main() {
   ...
   cl_context context = clCreateContext(ctxprop,1,&device,0,0,&err);
   ...
   err = clEnqueueNDRangeKernel(queue,kernel,1,0,gtdsz,ltdsz,0,0,&ev[0]);
