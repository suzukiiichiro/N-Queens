...
#
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
  # echo "N-Queen9 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化＋クイーンの一におる振り分け（BOUND1)";
  # N-Queen9;
#
#
# ---------------------------------------------------------------------------------
##
# １０．バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対象解除法のビットマップ化＋クイーンの位置による振り分け(BOUND1+BOUND2)
#
#
#
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
  # echo "N-Queen10 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化＋クイーンの一におる振り分け（BOUND1+BOUND2)";
  # N-Queen10;

# ---------------------------------------------------------------------------------
##
# １１．バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化＋クイーンの位置による振り分け（BOUND1+BOUND2)＋枝刈りと最適化）
#
#
...
#
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
   echo "N-Queen11 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋クイーンの一による振り分け（BOUND1+BOUND2)＋枝刈りと最適化";
   N-Queen11;
#
#
#
