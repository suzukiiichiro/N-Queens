...
##
 ...
 #  ３．バックトラック(BT)              							N-Queen3() 0:07_30
 #  ４．BT＋対称解除法                  							N-Queen4() 0:06:48
 #  ５．BT＋対称解除法＋枝刈り          							N-Queen5() 0:03:36
 #　６．BT＋ビットマップ(Bit)           							N-Queen6() 0:01:52
 #　７．BT＋Bit＋対称解除法    				  							N-Queen7() 0:07:32 
 #  ８．BT＋Bit＋対称解除法＋枝刈り     							N-Queen8() 0:07:42
 #  ９．BT＋Bit＋対称解除法のBit化      							N-Queen9()
 #１０．BT＋Bit＋対称解除Bit＋(BOUNT1)      					N-Queen10()
 #１１．BT＋Bit＋対称解除Bit＋(BOUND1,BOUND2)     		N-Queen11()
 #１２．BT＋Bit＋対称解除Bit＋(BOUND1,BOUND2)＋枝刈り N-Queen12()
#
############################################
# N-Queen
############################################
...
# 実行結果
#
N-Queen8 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化
#  N:        Total       Unique        hh:mm:ss
#  2:            0            0         0:00:00
#  3:            0            0         0:00:00
#  4:            2            1         0:00:01
...
# ---------------------------------------------------------------------------------
##
# ９．バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化
#
#
# ソースはここにはる
#
#
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
  # echo "N-Queen9 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化";
  # N-Queen9;
#
# ---------------------------------------------------------------------------------
##
# １０．バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化＋クイーンの位置による振り分け(BOUND1)
#
#
# ソースはここにはる
#
#
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
  # echo "N-Queen10 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化＋クイーンの一におる振り分け（BOUND1)";
  # N-Queen10;
#
#
# ---------------------------------------------------------------------------------
##
# １１．バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対象解除法のビットマップ化＋クイーンの位置による振り分け(BOUND1+BOUND2)
#
#
#
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
  # echo "N-Queen11 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化＋クイーンの一におる振り分け（BOUND1+BOUND2)";
  # N-Queen11;

# ---------------------------------------------------------------------------------
##
# １２．バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋対称解除法のビットマップ化＋クイーンの位置による振り分け（BOUND1+BOUND2)＋枝刈りと最適化）
#
#
...
#
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
   echo "N-Queen12 : バックトラック＋ビットマップ＋対称解除法＋枝刈りと最適化＋クイーンの一による振り分け（BOUND1+BOUND2)＋枝刈りと最適化";
   N-Queen12;
#
#
#
