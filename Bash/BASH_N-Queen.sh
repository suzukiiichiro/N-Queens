...
# ---------------------------------------------------------------------------------
##
# ６．バックトラック＋対称解除法＋枝刈りと最適化＋ビットマップ
#
...
# 実行はコメントアウトを外して、 $ ./BASH_N-Queen.sh 
   echo "N-Queen6 : バックトラック＋対称解除法＋枝刈りと最適化＋ビットマップ";
   N-Queen6;
#
#
#
# ---------------------------------------------------------------------------------
##
# ７．バックトラック＋対称解除法＋枝刈りと最適化＋ビットマップ＋クイーンの位置による振り分け
#
#
# ***********************************************************************
...
#
# 実行はコメントアウトを外して、 $ ./bash_n-queen.sh 
	# echo "N-Queen7 : バックトラック＋対称解除法＋枝刈りと最適化＋ビットマップ＋クイーンの位置による振り分け";
	# N-Queen7  ;
#
#
#
